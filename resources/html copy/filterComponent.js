...
<div class="filter-container">
  ...
  <div class="filter-group">
    <div class="filter-name">
      <label>Name*</label>
      <smart-input id="filterName" class="outlined" style="width:100%"></smart-input>
    </div>
    <div>
      ...
      <div class="filter-expression" id="expressionArea"></div>
...
class FilterComponent extends HTMLElement {
  constructor() {
    ...
    if (this.insertValuesDialog) {
      ...
      this.insertValuesDialog.addEventListener("open", () => {
        this.resetDialogState();
      });

      this.insertValuesDialog.addEventListener("close", () => {
      ...
      if (
        ...
        return {
          ...
          filter: {
            ...
            expression: this.expressionArea.textContent,
          },
        };
      }
  ...
  setupEventListeners() {
    this.shadow.querySelectorAll(".tab").forEach((tab) => {
      tab.addEventListener("click", () => {
        ...
        if (tabType === "columns") {
          ...
          parametersList.style.display = "nonoe";
    ...
    this.insertValuesBtn.addEventListener("click", () => {
      if (this.insertValuesDialog) {
    ...
    this.validateBtn.addEventListener("click", () => {
      if (!this.expressionArea.textContent.trim()) {
  ...
  insertFunction(functionName) {
    const currentText = this.expressionArea.textContent;
    this.expressionArea.textContent =
      currentText + (currentText ? " " : "") + functionName + "()";
    this.errorMessage.style.display = "none";
  }
  ...
  insertColumn(columnName) {
    const currentText = this.expressionArea.textContent;
    this.expressionArea.textContent =
      currentText + (currentText ? " " : "") + columnName;
    this.errorMessage.style.display = "none";
  }
  ...
  updateInitialValues() {
    ...
    this.expressionArea.textContent = expression;
  }
  ...
  insertSelectedValues() {
    if (this.selectedValues.size > 0) {
      ...
      const currentText = this.expressionArea.textContent;
      this.expressionArea.textContent =
        currentText + (currentText ? " " : "") + values.join(", ");
    }
  }
}

...
class SchedulerWizard extends HTMLElement {
  ...
  connectedCallback() {
    ...
    }, false, "SchedulerWizard");

    // Button events
    EventHandler.on(this.$("#saveBtn"), "click", () => this.save(), false, "SchedulerWizard");
    EventHandler.on(this.$("#cancelBtn"), "click", () => this.setAttribute("visibility", "close"), false, "SchedulerWizard");
  }

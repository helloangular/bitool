...
<div class="container">
  <div class="content">
    <div class="form-section">
      <h2 class="section-title">Function Definition</h2>
      ...
      <div class="form-group">
        ...
        <div style="display: flex; gap: 10px; margin-top: 10px; align-items: center;">
          ...
          <select id="functionList" onchange="insertSelectedFunction()"
            style="width: 200px; height: 35px; border: 1px solid #ccc; border-radius: 4px; padding: 5px;" disabled>
...
class LambdaFunctionBuilder extends HTMLElement {
  ...
  addParameter(type = 'int', name = '') {
    const container = this.shadowRoot.getElementById('paramsContainer');

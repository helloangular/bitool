    ...
    try {
      ...
      droppableArea.addEventListener("drop", (event) => {
        ...
        if (event.target.tagName === "RECTANGLE-COMPONENT") {
          ...
          this.shadowRoot.getElementById("table1").value = label;
          this.shadowRoot.getElementById("table2").value = table2;
          this.shadowRoot.getElementById("conn-id").value = conn_id;
          this.shadowRoot.getElementById("schema").value = schema;
        ...
        rectangle.setAttribute("alias", label);
